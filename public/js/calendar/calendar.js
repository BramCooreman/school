...
calendar = {
	...
	makeCalendar:function(year, month, day) {
		...
		if (start_day == 0) start_day = 7; //jos ensimmäinen päivä on sunnuntai
		...
		this.wrt("</table>");
		this.wrt("<input type='button' value='Peruuta' class='calendar-cancel' onclick='calendar.hideCalendar();' />");
